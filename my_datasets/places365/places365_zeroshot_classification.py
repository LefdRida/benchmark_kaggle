...
class Places365ZeroshotClassificationDataset(Places365, EmbeddingDataset):
    ...
    def set_training_paired_embeddings(self) -> None:        
        ...
        if self.split == "train":
            ...
            for i, (idx, _) in enumerate(sss.split(train_image_embeddings, train_labels)):
                train_idx = idx
            train_image_embeddings =  train_image_embeddings[train_idx]
    ...
    def get_test_data(self) -> Tuple[np.ndarray, np.ndarray]:
        ...
        if self.split == "large":
            ...
            for i, (idx, _) in enumerate(sss.split(val_image_embeddings, val_labels)):
                val_idx = idx
            val_image_embeddings =  val_image_embeddings[val_idx]
