    ...
    for img_embedding_model_name in all_img_embedding_model_name:
        ...
        for task in config.tasks:
            ...
            OmegaConf.update(
                ...
                f"imagenet1k_val_{img_embedding_model_name}_image_embeddings.pkl"
                )
            # OmegaConf.update(
            #     config, 
            ...
            for n in n_clusters:
                ...
                with open("knn_diff_models.json", "w") as f:
                    json.dump(results_logs, f, default=lambda o: float(o) if isinstance(o, np.floating) else int(o) if isinstance(o, np.integer) else o)
