...
from ..base import AbsMethod
# Importing from original structure
from method.csa.csa import NormalizedCCA
...
class CSAMethod(AbsMethod):
    ...
    def align(self, image_embeddings: np.ndarray, text_embeddings: np.ndarray, support_embeddings: Dict[str, np.ndarray], mode: str = "image", **kwargs) -> np.ndarray:
        ...
        image_embeddings, text_embeddings = self.cca.cca.transform(image_embeddings_centred, text_embeddings_centred)
